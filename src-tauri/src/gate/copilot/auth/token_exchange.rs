...
use crate::gate::copilot::auth::constants::{API_VERSION, COPILOT_TOKEN_URL, EDITOR_PLUGIN_VERSION};
use crate::gate::copilot::auth::device_flow::mask_token;
use crate::gate::copilot::error::{Error, Result};
use crate::gate::copilot::models::auth::CopilotTokenResponse;
...
///
/// # async fn example(github_token: &str) -> crate::gate::copilot::Result<()> {
