...
use crate::gate::copilot::auth::constants::{
...
use crate::gate::copilot::models::auth::{DeviceCodeResponse, GitHubTokenResponse};
...
///
/// ```no_run
/// use crate::gate::copilot::auth::device_flow::start_device_flow;
///
...
///
/// ```no_run
/// use crate::gate::copilot::auth::device_flow::{poll_for_token, PollResult};
/// use tokio::time::{sleep, Duration};
///
/// # async fn example(pending: &crate::gate::copilot::auth::device_flow::DeviceFlowPending) -> crate::gate::copilot::Result<String> {
/// let client = reqwest::Client::new();
