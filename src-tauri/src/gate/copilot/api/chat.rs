...
use crate::gate::copilot::client::CopilotClient;
use crate::gate::copilot::error::{Error, Result};
use crate::gate::copilot::models::{
    ChatRequest, ChatResponse, Content, Message, Role, SseParser, StreamChunk,
};
use crate::gate::copilot::storage::CopilotTokenStorage;
...
impl<'a, S: CopilotTokenStorage> ChatRequestBuilder<'a, S> {
    ...
    pub fn user_with_image(mut self, text: &str, image_url: &str) -> Self {
        use crate::gate::copilot::models::{ContentPart, ImageUrl};
    ...
    ///     match chunk? {
    ///         crate::gate::copilot::StreamChunk::Delta { content, .. } => {
    ///             print!("{content}");
    ///         }
    ///         crate::gate::copilot::StreamChunk::Done => break,
    ///         _ => {}
    ///     }
    /// }
    /// # Ok(())
