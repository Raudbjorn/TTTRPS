...
use crate::gate::gemini::error::{Error, Result};
use crate::gate::gemini::models::google::CloudCodeWrapper;
...
///
/// ```rust,ignore
/// use crate::gate::gemini::transport::HttpClient;
///
...
///
/// ```rust
/// use crate::gate::gemini::transport::HttpClientBuilder;
/// use std::time::Duration;
///
...
pub(crate) fn wrap_request(
    project_id: &str,
    model: &str,
    request: crate::gate::gemini::models::google::GoogleRequest,
) -> CloudCodeWrapper {
...
///
/// ```
/// use crate::gate::gemini::transport::http::mask_token;
///
...
pub fn build_api_path(streaming: bool) -> &'static str {
    if streaming {
        crate::gate::gemini::constants::API_PATH_STREAM_GENERATE_CONTENT
    } else {
        crate::gate::gemini::constants::API_PATH_GENERATE_CONTENT
    }
}
...
mod tests {
    ...
    fn test_wrap_request() {
        use crate::gate::gemini::models::google::{Content, GoogleRequest, Part};
