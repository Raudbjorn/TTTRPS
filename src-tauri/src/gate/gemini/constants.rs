...
/// # Security Note
///
/// These credentials are intentionally public and match the desktop
/// Antigravity application. For desktop/native OAuth applications,
/// embedding client credentials is a standard pattern (see RFC 8252
/// Section 8.5) since native apps cannot securely store secrets.
/// Google's OAuth flow for desktop apps relies on the redirect URI
/// and PKCE for security rather than client secret confidentiality.
pub const DEFAULT_OAUTH_CONFIG: OAuthConfig = OAuthConfig {
    // Public OAuth client ID for desktop application OAuth flow
    client_id: "1071006060591-tmhssin2h21lcre235vtolojh4g403ep.apps.googleusercontent.com",
    // Public OAuth client secret (see security note above)
...
///
/// ```
/// use crate::gate::gemini::constants::{get_model_family, ModelFamily};
///
...
///
/// ```
/// use crate::gate::gemini::constants::is_thinking_model;
///
...
pub const ANTIGRAVITY_SYSTEM_INSTRUCTION: &str = r#"You are Antigravity, a powerful agentic AI coding assistant designed by the Google Deepmind team working on Advanced Agentic Coding.
