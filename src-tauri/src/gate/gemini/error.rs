...
impl From<crate::gate::error::Error> for Error {
    fn from(err: crate::gate::error::Error) -> Self {
        match err {
            crate::gate::error::Error::Auth(auth_err) => Error::Auth(match auth_err {
                crate::gate::error::AuthError::NotAuthenticated => AuthError::NotAuthenticated,
                crate::gate::error::AuthError::TokenExpired => AuthError::TokenExpired,
                crate::gate::error::AuthError::InvalidGrant => AuthError::InvalidGrant,
                crate::gate::error::AuthError::StateMismatch => AuthError::StateMismatch,
                crate::gate::error::AuthError::PkceVerificationFailed => AuthError::InvalidGrant, // Closest map
                crate::gate::error::AuthError::Cancelled => AuthError::Cancelled,
                crate::gate::error::AuthError::ProjectDiscovery(msg) => AuthError::ProjectDiscovery(msg),
                crate::gate::error::AuthError::RefreshFailed(msg) => AuthError::TokenExchange(format!("Refresh failed: {}", msg)),
            }),
            crate::gate::error::Error::Api {
                status,
                message,
                retry_after,
            } => Error::Api {
            ...
            crate::gate::error::Error::Network(e) => Error::Network(e),
            ...
            crate::gate::error::Error::Url(_) => Error::Config("URL error".into()), // No direct URL variant
        }
    }
}
