//! Gemini/Cloud Code API client module.
//!
...
// Re-export storage types at module root
pub use storage::{
...
// Re-export public conversion utilities at module root
pub use convert::{convert_role, sanitize_schema, SignatureCache, GLOBAL_SIGNATURE_CACHE};

// Re-export client types at module root
pub use client::{
