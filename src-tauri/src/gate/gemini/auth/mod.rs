...
//!
//! ```rust,ignore
//! use crate::gate::gemini::auth::OAuthFlow;
...
//!
//! ```rust,ignore
//! use crate::gate::gemini::auth::project::{discover_project, ProjectInfo};
//!
//! # async fn example() -> crate::gate::gemini::Result<()> {
...
pub mod oauth;
pub mod project;
// mod token; // Removed local token module
...
pub use crate::gate::token::TokenInfo; // Use unified TokenInfo
