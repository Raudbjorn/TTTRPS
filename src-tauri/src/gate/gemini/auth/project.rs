...
//!
//! ```rust,ignore
//! use crate::gate::gemini::auth::project::{discover_project, ProjectInfo, SubscriptionTier};
//!
...
impl std::str::FromStr for SubscriptionTier {
    ...
    ///
    /// ```
    /// use crate::gate::gemini::auth::project::SubscriptionTier;
    /// use std::str::FromStr;
    ///
...
///
/// ```rust,ignore
/// use crate::gate::gemini::auth::project::discover_project;
///
/// # async fn example() -> crate::gate::gemini::Result<()> {
...
///
/// ```rust,ignore
/// use crate::gate::gemini::auth::project::onboard_user;
///
/// # async fn example() -> crate::gate::gemini::Result<()> {
