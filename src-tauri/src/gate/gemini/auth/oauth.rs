...
//!
//! ```rust,ignore
//! use crate::gate::gemini::auth::oauth::{generate_pkce, generate_state, build_authorization_url};
//! use crate::gate::gemini::DEFAULT_OAUTH_CONFIG;
//!
...
use super::TokenInfo;
use crate::gate::gemini::constants::OAuthConfig;
use crate::gate::gemini::error::{AuthError, Error, Result};
...
///
/// ```
/// use crate::gate::gemini::auth::oauth::generate_pkce;
///
/// let (verifier, challenge) = generate_pkce();
///
...
///
/// ```
/// use crate::gate::gemini::auth::oauth::generate_state;
///
...
///
/// ```rust,ignore
/// use crate::gate::gemini::auth::oauth::exchange_code;
/// use crate::gate::gemini::DEFAULT_OAUTH_CONFIG;
///
...
pub async fn exchange_code(config: &OAuthConfig, code: &str, verifier: &str) -> Result<TokenInfo> {
    ...
    let refresh_token = token_response.refresh_token.ok_or_else(|| {
        Error::Auth(AuthError::TokenExchange(
...
///
/// ```rust,ignore
/// use crate::gate::gemini::auth::oauth::refresh_token;
/// use crate::gate::gemini::DEFAULT_OAUTH_CONFIG;
///
