...
use crate::gate::gemini::models::content::ContentBlock;
use crate::gate::gemini::models::google::GoogleResponse;
use crate::gate::gemini::models::response::{MessagesResponse, StopReason, Usage};
...
///
/// ```rust,ignore
/// use crate::gate::gemini::convert::convert_response;
///
/// let google_response = /* ... */;
...
pub(crate) fn convert_response(response: &GoogleResponse, model: &str) -> MessagesResponse {
    ...
    MessagesResponse {
        ...
        role: crate::gate::gemini::models::request::Role::Assistant,
        content,
...
mod tests {
    use super::*;
    use crate::gate::gemini::models::google::{Candidate, Content, FunctionCall, Part, UsageMetadata};
    use serde_json::json;
    ...
    fn test_convert_simple_text_response() {
        ...
        assert_eq!(result.role, crate::gate::gemini::models::request::Role::Assistant);
