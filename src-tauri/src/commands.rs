...
pub async fn list_ttrpg_documents_by_source(
    ...
    db.list_ttrpg_documents_by_source(&source_document_id)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn list_ttrpg_documents_by_type(
    ...
    let db_guard = db.read().await;
    let db = db_guard.as_ref().ok_or("Database not initialized")?;
    db.list_ttrpg_documents_by_type(&element_type)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn list_ttrpg_documents_by_system(
    ...
    let db_guard = db.read().await;
    let db = db_guard.as_ref().ok_or("Database not initialized")?;
    db.list_ttrpg_documents_by_system(&game_system)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn search_ttrpg_documents_by_name(
    ...
    let db_guard = db.read().await;
    let db = db_guard.as_ref().ok_or("Database not initialized")?;
    db.search_ttrpg_documents_by_name(&name_pattern)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn list_ttrpg_documents_by_cr(
    ...
    let db_guard = db.read().await;
    let db = db_guard.as_ref().ok_or("Database not initialized")?;
    db.list_ttrpg_documents_by_cr(min_cr, max_cr)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn get_ttrpg_document_attributes(
    ...
    let db_guard = db.read().await;
    let db = db_guard.as_ref().ok_or("Database not initialized")?;
    db.get_ttrpg_document_attributes(&document_id)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn find_ttrpg_documents_by_attribute(
    ...
    let db_guard = db.read().await;
    let db = db_guard.as_ref().ok_or("Database not initialized")?;
    db.find_ttrpg_documents_by_attribute(&attribute_type, &attribute_value)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn count_ttrpg_documents_by_type(
    ...
    let db_guard = db.read().await;
    let db = db_guard.as_ref().ok_or("Database not initialized")?;
    db.count_ttrpg_documents_by_type()
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn get_ttrpg_ingestion_job(
    ...
    let db_guard = db.read().await;
    let db = db_guard.as_ref().ok_or("Database not initialized")?;
    db.get_ttrpg_ingestion_job(&job_id)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn get_ttrpg_ingestion_job_by_document(
    ...
    let db_guard = db.read().await;
    let db = db_guard.as_ref().ok_or("Database not initialized")?;
    db.get_ttrpg_ingestion_job_by_document(&document_id)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn list_pending_ttrpg_ingestion_jobs(
    ...
    let db_guard = db.read().await;
    let db = db_guard.as_ref().ok_or("Database not initialized")?;
    db.list_pending_ttrpg_ingestion_jobs()
        .await
        .map_err(|e| e.to_string())
}
