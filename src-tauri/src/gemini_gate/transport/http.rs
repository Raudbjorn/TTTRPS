...
use crate::gemini_gate::models::google::CloudCodeWrapper;
...
pub(crate) fn wrap_request(
    project_id: &str,
    model: &str,
    request: crate::gemini_gate::models::google::GoogleRequest,
) -> CloudCodeWrapper {
...
pub fn build_api_path(streaming: bool) -> &'static str {
    if streaming {
        crate::gemini_gate::constants::API_PATH_STREAM_GENERATE_CONTENT
    } else {
        crate::gemini_gate::constants::API_PATH_GENERATE_CONTENT
    }
}
...
mod tests {
    ...
    fn test_wrap_request() {
        use crate::gemini_gate::models::google::{Content, GoogleRequest, Part};
