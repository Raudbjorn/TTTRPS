...
use crate::gemini_gate::models::google::GoogleResponse;
use crate::gemini_gate::models::response::{MessagesResponse, StopReason, Usage};
...
pub(crate) fn convert_response(response: &GoogleResponse, model: &str) -> MessagesResponse {
    ...
    MessagesResponse {
        ...
        role: crate::gemini_gate::models::request::Role::Assistant,
        content,
...
mod tests {
    use super::*;
    use crate::gemini_gate::models::google::{Candidate, Content, FunctionCall, Part, UsageMetadata};
    use serde_json::json;
    ...
    fn test_convert_simple_text_response() {
        ...
        assert_eq!(result.role, crate::gemini_gate::models::request::Role::Assistant);
